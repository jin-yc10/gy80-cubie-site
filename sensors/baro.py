...
class BMP085 :
  ...
  def readRawTemp(self):
    ...
    self.i2c.write_byte(self.__BMP085_CONTROL, self.__BMP085_READTEMPCMD)
  ...
  def readRawPressure(self):
    ...
    self.i2c.write_byte(self.__BMP085_CONTROL, self.__BMP085_READPRESSURECMD + (self.mode << 6))
